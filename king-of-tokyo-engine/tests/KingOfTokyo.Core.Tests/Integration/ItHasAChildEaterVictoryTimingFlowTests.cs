...
public sealed class ItHasAChildEaterVictoryTimingFlowTests
{
    [Fact]
    public void EndTurn_Should_EndGame_WhenEaterOwnerReachesTwentyFromItHasAChildElimination()
    {
        ...
        defender.AddKeepCard(CreateKeepCard(KnownCardIds.ItHasAChild, "It Has a Child", 7));
        defender.AddKeepCard(CreateKeepCard(KnownCardIds.GiantBrain, "Giant Brain", 5));

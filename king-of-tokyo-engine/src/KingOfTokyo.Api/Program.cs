...
games.MapPost("/{gameId:guid}/commands/activate-wings", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-rapid-healing", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
    return Execute(gameId, store, (engine, state) => engine.Execute(state, new ActivateRapidHealingCommand(request.ActorPlayerId)));
});

games.MapPost("/{gameId:guid}/commands/activate-healing-ray", (Guid gameId, HealingRayRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/set-mimic-target", (Guid gameId, SetMimicTargetRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-telepath", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
    return Execute(gameId, store, (engine, state) => engine.Execute(state, new ActivateTelepathCommand(request.ActorPlayerId)));
});

games.MapPost("/{gameId:guid}/commands/activate-stretchy", (Guid gameId, ChangeDieFaceRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-herd-culler", (Guid gameId, DieIndexRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-smoke-cloud", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-plot-twist", (Guid gameId, ChangeDieFaceRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-metamorph", (Guid gameId, MetamorphRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/activate-psychic-probe", (Guid gameId, PsychicProbeRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/buy-owned-keep-card", (Guid gameId, BuyOwnedKeepCardRequest request, InMemoryGameSessionStore store) =>
{
...
games.MapPost("/{gameId:guid}/commands/peek-top-deck-card", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
    return Execute(gameId, store, (engine, state) => engine.Execute(state, new PeekTopDeckCardCommand(request.ActorPlayerId)));
});

games.MapPost("/{gameId:guid}/commands/buy-peeked-top-deck-card", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
    return Execute(gameId, store, (engine, state) => engine.Execute(state, new BuyPeekedTopDeckCardCommand(request.ActorPlayerId)));
});

games.MapPost("/{gameId:guid}/commands/decline-peeked-top-deck-card", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
    return Execute(gameId, store, (engine, state) => engine.Execute(state, new DeclinePeekedTopDeckCardCommand(request.ActorPlayerId)));
});

games.MapPost("/{gameId:guid}/commands/buy-opportunist-revealed-card", (Guid gameId, ActorRequest request, InMemoryGameSessionStore store) =>
{
...
static int RequireActor(int? actorPlayerId)
{
